...
function Newsletter() {
  return (
    <div className='newsletter relative'>
        <div className="text-[3.5em] xl:text-[8.5em] font-semibold leading-[151px] text-[#f2f3f7] absolute top-[30%] left-[0%] md:left-[25%]">Newsletter</div>
        <div className="newsletter_inner w-full xl:w-[50%] m-auto text-center py-[10em] relative">
            ...
            <Button type="submit" className='w-[200px]'>Get Started</Button>
            </div>
        </div>
    </div>
  )
